...
import mapper.htmlscrappers.table.TableScrapper;
...
class TableScrapperTest extends ScrapperTest {
    ...
    private TableScrapper tableMapper = new TableScrapper();
    ...
    @Test
    void shouldScrapSimpleTableWithStylization() {
        //given
        Element table = sampleTables.getElementById("shouldScrapSimpleTableWithStylization");
        //when
        Appendix actualAppendix = tableMapper.scrapElement(table);
        //then
        assertEquals(expectedOutputs.get("shouldScrapSimpleTableWithStylization").get(0), actualAppendix);
    }
