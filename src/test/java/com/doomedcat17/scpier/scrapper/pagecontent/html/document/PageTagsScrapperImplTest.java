...
import com.doomedcat17.scpier.pagecontent.html.document.PageTagsScrapper;
import com.doomedcat17.scpier.pagecontent.html.document.PageTagsScrapperImpl;
...
class PageTagsScrapperImplTest {
    ...
    void shouldScrapTags1() {
        //given
        Document document = TestDataProvider.loadDocumentFormHTML("src/test/resources/html/testdata/document/sampleScpWithTags1.html");
        //when
    ...
    void shouldScrapTags2() {
        //given
        Document document = TestDataProvider.loadDocumentFormHTML("src/test/resources/html/testdata/document/sampleScpWithTags2.html");
        //when
        Optional<List<String>> foundTags = pageTagsScrapper.scrapPageTags(document);
        //then
        assertTrue(foundTags.isPresent());
